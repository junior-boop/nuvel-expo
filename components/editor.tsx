...
export default function EditorPage({ id, updateNote, Note }: { id: string, updateNote: (data: Partial<Notes>) => void, Note: Notes }) {
    ...
    return (
        // <div className="flex flex-1 text-xl">je suis dans la joie</div>
