  ...
  return (<TouchableOpacity onPress={handleOpen} style={{ paddingHorizontal: convert(16), gap: convert(12) }}>
    <View>
      ...
      <View style={{ flexDirection: 'row', gap: convert(8), alignItems: 'center' }}>
        ...
        <Text style={{ fontSize: convert(13), color: "#444", fontWeight: "bold", textTransform: "uppercase", marginBottom: convert(-3) }}>{articles.viewCount} reads</Text><Text style={{ fontSize: convert(16), color: "#444" }}>• {moment(articles.article?.createdAt).fromNow()}</Text>
      </View>
    </View>
