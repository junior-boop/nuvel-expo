...
export function FluentTextBold24Regular(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M6.935 4.44A1.5 1.5 0 0 1 7.996 4h4.384C15.016 4 17 6.182 17 8.625a4.63 4.63 0 0 1-.866 2.682c1.077.827 1.866 2.12 1.866 3.813c0 3.112-2.7 4.88-4.88 4.88H8a1.5 1.5 0 0 1-1.5-1.5l-.004-13c0-.397.158-.779.44-1.06M9.5 10.25h2.88c.903 0 1.62-.76 1.62-1.625S13.282 7 12.38 7H9.498zm0 3V17h3.62c.874 0 1.88-.754 1.88-1.88c0-1.13-.974-1.87-1.88-1.87z" /></svg>
    )
}


export function FluentTextItalic24Filled(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M10.649 18.5h3.847a1 1 0 0 1 0 2h-9.5a.997.997 0 0 1-.996-1c0-.552.445-1 .996-1h3.51L13.332 6H9.997a1 1 0 0 1 0-2H18.5a1 1 0 0 1 0 2h-3.025z" /></svg>
    )
}
...
export function FluentTextHeader3Lines24Regular(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M3.5 2.75a.75.75 0 0 0-1.5 0v7.5a.75.75 0 0 0 1.5 0V7h4v3.244a.75.75 0 0 0 1.5 0V2.752a.75.75 0 1 0-1.5 0V5.5h-4zm-1.5 17a.75.75 0 0 1 .75-.75h18.5a.75.75 0 0 1 0 1.5H2.75a.75.75 0 0 1-.75-.75M2.75 14a.75.75 0 0 0 0 1.5h18.5a.75.75 0 0 0 0-1.5zM14.586 3.577c-.684-.206-1.72.015-2.292.616a.75.75 0 0 1-1.088-1.033c.983-1.034 2.616-1.38 3.813-1.019c.812.245 1.462.802 1.778 1.52c.324.734.276 1.6-.255 2.345q-.208.29-.453.496q.245.206.453.496c.53.746.579 1.611.255 2.345c-.316.718-.966 1.275-1.778 1.52c-1.197.362-2.83.015-3.813-1.019a.75.75 0 1 1 1.088-1.033c.572.601 1.608.823 2.291.616c.429-.13.715-.405.84-.688c.117-.266.11-.57-.105-.871c-.394-.552-1.06-.611-1.836-.616h-.129a.75.75 0 0 1 0-1.5h.129c.776-.005 1.442-.063 1.836-.616c.214-.301.222-.604.104-.87c-.124-.284-.41-.56-.838-.689" /></svg>
    )
}



export function FluentAppsList20Filled(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M8 4.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m-6-1A1.5 1.5 0 0 1 3.5 14h1A1.5 1.5 0 0 1 6 15.5v1A1.5 1.5 0 0 1 4.5 18h-1A1.5 1.5 0 0 1 2 16.5zm0-6A1.5 1.5 0 0 1 3.5 8h1A1.5 1.5 0 0 1 6 9.5v1A1.5 1.5 0 0 1 4.5 12h-1A1.5 1.5 0 0 1 2 10.5zm0-6A1.5 1.5 0 0 1 3.5 2h1A1.5 1.5 0 0 1 6 3.5v1A1.5 1.5 0 0 1 4.5 6h-1A1.5 1.5 0 0 1 2 4.5z" /></svg>
    )
}


export function FluentTextNumberList24Regular(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M6 2.75a.75.75 0 0 0-1.434-.307l-.002.003l-.011.024l-.056.108a4 4 0 0 1-.238.385c-.217.312-.524.662-.906.901a.75.75 0 1 0 .794 1.272q.188-.117.353-.248V7.25a.75.75 0 1 0 1.5 0zm14.5 16a.75.75 0 0 0-.75-.75h-9a.75.75 0 0 0 0 1.5h9a.75.75 0 0 0 .75-.75m0-6.506a.75.75 0 0 0-.75-.75h-9a.75.75 0 0 0 0 1.5h9a.75.75 0 0 0 .75-.75m0-6.494a.75.75 0 0 0-.75-.75h-9a.75.75 0 0 0 0 1.5h9a.75.75 0 0 0 .75-.75M5.15 10.52c-.3-.053-.676.066-.87.26a.75.75 0 0 1-1.06-1.06c.556-.556 1.43-.812 2.192-.677c.397.07.805.254 1.115.605c.316.358.473.825.473 1.352c0 .62-.271 1.08-.606 1.42c-.278.283-.63.511-.906.689l-.08.051a6 6 0 0 0-.481.34H6.25a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75c0-1.313.984-1.953 1.575-2.337l.06-.04c.318-.205.533-.345.69-.504c.134-.136.175-.238.175-.369c0-.223-.061-.318-.098-.36a.42.42 0 0 0-.251-.12M2.97 21.28s.093.084.004.005l.006.005l.013.013a1.4 1.4 0 0 0 .15.125c.095.071.227.158.397.243c.341.17.83.33 1.46.33c.64 0 1.196-.182 1.601-.54c.408-.36.61-.858.595-1.36a1.78 1.78 0 0 0-.426-1.1c.259-.306.412-.686.426-1.102a1.73 1.73 0 0 0-.595-1.36C6.196 16.182 5.64 16 5 16c-.63 0-1.119.158-1.46.33a2.6 2.6 0 0 0-.51.334l-.037.033l-.013.013l-.006.005l-.002.003H2.97l-.001.002a.75.75 0 0 0 1.048 1.072l.026-.02a1 1 0 0 1 .166-.101c.159-.08.42-.17.79-.17c.36 0 .536.099.608.163a.23.23 0 0 1 .088.187a.33.33 0 0 1-.123.23c-.089.078-.263.17-.573.17a.75.75 0 0 0 0 1.5c.31 0 .484.09.573.167c.091.08.121.166.123.231a.23.23 0 0 1-.088.188c-.072.063-.247.163-.608.163a1.75 1.75 0 0 1-.79-.17a1 1 0 0 1-.192-.122a.75.75 0 0 0-1.048 1.072m.002-4.562c.007-.005.2-.166 0 0" /></svg>
    )
}


export function FluentCodeBlock32Regular(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M3 7.5A4.5 4.5 0 0 1 7.5 3h17A4.5 4.5 0 0 1 29 7.5v17a4.5 4.5 0 0 1-4.5 4.5h-17A4.5 4.5 0 0 1 3 24.5zM7.5 5A2.5 2.5 0 0 0 5 7.5v17A2.5 2.5 0 0 0 7.5 27h17a2.5 2.5 0 0 0 2.5-2.5v-17A2.5 2.5 0 0 0 24.5 5zm6.207 5.293a1 1 0 0 1 0 1.414L9.414 16l4.293 4.293a1 1 0 0 1-1.414 1.414l-5-5a1 1 0 0 1 0-1.414l5-5a1 1 0 0 1 1.414 0m4.586 1.414a1 1 0 0 1 1.414-1.414l5 5a1 1 0 0 1 0 1.414l-5 5a1 1 0 0 1-1.414-1.414L22.586 16z" /></svg>
    )
}


export function FluentTextQuote32Filled(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M9.5 5A4.5 4.5 0 0 1 14 9.5c0 5.453-1.562 9.265-3.161 11.731a15.2 15.2 0 0 1-2.21 2.702c-.305.292-.563.51-.75.659q-.141.11-.225.17q-.06.044-.087.062l-.007.005l-.003.001l-.001.001l-.001.001a1 1 0 0 1-1.11-1.663h-.003l.004-.002a3 3 0 0 0 .19-.144c.142-.111.352-.288.61-.534a13.2 13.2 0 0 0 1.915-2.345c1-1.543 2.017-3.739 2.518-6.707A4.5 4.5 0 1 1 9.5 5m13 0A4.5 4.5 0 0 1 27 9.5c0 5.453-1.562 9.265-3.161 11.731a15.2 15.2 0 0 1-2.21 2.702a11 11 0 0 1-.75.659q-.142.11-.225.17q-.06.044-.087.062l-.007.005l-.003.001l-.001.001l-.001.001a1 1 0 0 1-1.11-1.663h-.003l.004-.002a3 3 0 0 0 .19-.144a9 9 0 0 0 .61-.534a13.2 13.2 0 0 0 1.915-2.345c1-1.543 2.017-3.739 2.518-6.707A4.5 4.5 0 1 1 22.5 5" /></svg>
    )
}


export function FluentLineHorizontal128Regular(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 28 28" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M2 13.75a.75.75 0 0 1 .75-.75h22.5a.75.75 0 0 1 0 1.5H2.75a.75.75 0 0 1-.75-.75" /></svg>
    )
}


export function FluentArrowEnterLeft24Filled(props: SVGProps<SVGSVGElement>) {
    return (
...
export function BxsBible(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>{/* Icon from BoxIcons Solid by Atisa - https://creativecommons.org/licenses/by/4.0/ */}<path fill="currentColor" d="M6 22h15v-2H6.012C5.55 19.988 5 19.805 5 19s.55-.988 1.012-1H21V4a2 2 0 0 0-2-2H6c-1.206 0-3 .799-3 3v14c0 2.201 1.794 3 3 3M8 7h3V5h2v2h3v2h-3v6h-2V9H8z" /></svg>
    )
}
...
export function IcSharpArrowDownward(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" {...props}>{/* Icon from Google Material Icons by Material Design Authors - https://github.com/material-icons/material-icons/blob/master/LICENSE */}<path fill="currentColor" d="m20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8z" /></svg>
    )
}


export function FluentChevronDown12Filled(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 12 12" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M2.22 4.47a.75.75 0 0 1 1.06 0L6 7.19l2.72-2.72a.75.75 0 0 1 1.06 1.06L6.53 8.78a.75.75 0 0 1-1.06 0L2.22 5.53a.75.75 0 0 1 0-1.06" /></svg>
    )
}


export function FluentArrowUndo16Regular(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M3 2.5a.5.5 0 0 1 1 0v3.843l3.171-3.171a4 4 0 0 1 5.657 5.656l-5.025 5.026a.5.5 0 0 1-.707-.708l5.025-5.025A3 3 0 1 0 7.878 3.88L4.757 7H8.5a.5.5 0 0 1 0 1H3.6a.6.6 0 0 1-.6-.6z" /></svg>
    )
}



export function FluentTextUnderlineCharacterU16Filled(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" {...props}>{/* Icon from Fluent UI System Icons by Microsoft Corporation - https://github.com/microsoft/fluentui-system-icons/blob/main/LICENSE */}<path fill="currentColor" d="M6 2.75a.75.75 0 0 0-1.5 0V7.5a3.5 3.5 0 1 0 7 0V2.75a.75.75 0 0 0-1.5 0V7.5a2 2 0 1 1-4 0zM4.75 12.5a.75.75 0 0 0 0 1.5h6.5a.75.75 0 0 0 0-1.5z" /></svg>
    )
}


export function FluentLinkAdd20Filled(props: SVGProps<SVGSVGElement>) {
    return (
