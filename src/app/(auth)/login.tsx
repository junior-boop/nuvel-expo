        ...
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.container}>
            ...
            <View style={styles.container}>
                <View style={{ width: (w * 80 / 100), gap: convert(12) }}>
                    ...
                    <View>
                        <TextInput style={{ paddingHorizontal: convert(12), paddingVertical: convert(12), fontSize: convert(18), fontWeight: "700", color: '#444', borderWidth: 1, borderColor: "#ccc" }} placeholder='first name' placeholderTextColor={"#ccc"} onChangeText={(e) => { if (__DEV__) console.log(e); setName(e) }} keyboardType='default' />
                    </View>
                    <View>
                        <TextInput style={{ paddingHorizontal: convert(12), paddingVertical: convert(12), fontSize: convert(18), fontWeight: "700", color: '#444', borderWidth: 1, borderColor: "#ccc" }} placeholder='Last Name' placeholderTextColor={"#ccc"} onChangeText={(e) => { if (__DEV__) console.log(e); setFirstName(e) }} keyboardType='default' />
                    </View>
                    <View>
                        <TextInput style={{ paddingHorizontal: convert(12), paddingVertical: convert(12), fontSize: convert(18), fontWeight: "700", color: '#444', borderWidth: 1, borderColor: "#ccc" }} placeholder='Type your email address' placeholderTextColor={"#ccc"} inputMode='email' onChangeText={(e) => { if (__DEV__) console.log(e); setEmail(e) }} keyboardType='email-address' autoCapitalize='none' autoCorrect={false} />
                    </View>
                    <View>
